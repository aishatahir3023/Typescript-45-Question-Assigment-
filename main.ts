...
let JeanPaulsartre:string = "Everything has been figured out, except how to live"
...
let names: string[] = ["Aisha", "Tahir", "Aizah", "Zahra", "Alisha",]
...
for (let friendnames of names) {
    console.log(`Hello ${friendnames} what is going on today?`);
}

// 13. Your Own Array: Think of your favorite mode of transportation, such as a motorcycle or a car, and make a list that stores several examples. Use your list to print a series of statements about these items, such as “I would like to own a Honda motorcycle.”

let transportation: string[] = ["motorcycle", "car", "bike", "bus", "train"]
...
let guestList: string[] = ["Rani", "Roohi", "Sabeen"];
...
console.log(`Sorry My Dear ${guestList1} you are not invited`);

let guestList2 = guestList.pop();
console.log(`Sorry My Dear ${guestList2} you are not invited`);

let guestList3 = guestList.pop();
console.log(`Sorry My Dear ${guestList3} you are not invited`);
...
let places: string[] = ["Gilgit", "Naran", "Kaghan", "Islamabad", "Kashmir"]
...
console.log("Alphabatiacal order:" ,[...places].sort());
...
let array = ["facepowder", "lipstick", "eyepencil", "shainer"]
...
let UserName = ["Ahmed", "Asad", "Abbu", "Ammi", "Admin", "Almir"];
...
let UserName1 = ["Ahmed", "Asad", "Abbu", "Ammi", "Admin", "Almir"];
...
let Current_Users = ["Ahmed", "Asad", "Abbu", "Ammi", "Almir"];
let New_Users = ["Aisha", "maryam", "Ammi", "Bilal", "Almir"];
...
New_Users.forEach(New_Users =>{
    ...
    if(usernameTaken){
        console.log(`The username ${New_Users} has already been taken`);
    }else{
...
let Pizza = ["Chicken Tikka", "Malai Pizza", "chicken Mughalai"];
...
let magicians = ["Aisha", "Aizah", "Zahra"];

function show_magicians(magicians:string[]){
    for(let oneMagician of magicians){
...
let newMagicians = make_great1(magicians);
...
function cars(manufacturer:string, model:string,...features:string[]){
    let car = {
